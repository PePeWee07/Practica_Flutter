...
class UserRandomModel {
  ...
  UserRandomModel({required this.results, required this.info});

  factory UserRandomModel.fromJson(Map<String, dynamic> json) => UserRandomModel(
    results: List<RandomUser>.from(
      json["results"].map((x) => RandomUser.fromJson(x)),
    ),
...
class Dob {
  ...
  factory Dob.fromJson(Map<String, dynamic> json) =>
      Dob(date: DateTime.parse(json["date"]), age: json["age"]);

  Map<String, dynamic> toJson() => {"date": date.toIso8601String(), "age": age};
}
...
class Id {
  ...
  factory Id.fromJson(Map<String, dynamic> json) =>
      Id(name: json["name"], value: json["value"]);
...
class Street {
  ...
  factory Street.fromJson(Map<String, dynamic> json) =>
      Street(number: json["number"], name: json["name"]);
...
class Timezone {
  ...
  factory Timezone.fromJson(Map<String, dynamic> json) =>
      Timezone(offset: json["offset"], description: json["description"]);
